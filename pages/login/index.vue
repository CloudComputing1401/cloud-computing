        ...
        <div class="px-5">
          ...
          <div class="w-full h-[70px]">
            <v-expand-transition>
              <div
                v-if="showError"
                class="w-full h-[60px] border-2 border-red-500 rounded-md px-4 py-2 d-flex items-center"
              >
          ...
          <v-expand-transition>
            <div v-if="!forgetPass" class="w-full mt-5">
              ...
              <nuxt-link to="/register">
                <div
                  v-ripple
                  class="w-full h-[50px] flex-center bg-[#E0E0E0] rounded-md mt-3 text-black regular"
                >
                  ثبت نام
                </div>
              </nuxt-link>
